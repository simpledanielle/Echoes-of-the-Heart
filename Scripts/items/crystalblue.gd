...
var dialogue_tree = {
	"start": {
		"text": "A crystal. Looks a little fragile",
		"choices": [
			{"text": "Smash it", "next": "smash_it"},
			{"text": "Admire it", "next": "admire_it"}
		]
	},
	"smash_it": {
		"text": "You heard a shreik!",
		"choices": []
	},
	"leave_it": {
		"text": "You looked at the crystal. There is a small child inside.",
		"choices": []
	}
}
